...
export default function MainLayout({ isDarkMode, toggleTheme, onLogout }) {
  ...
  return (
    ...
    >
      <Sidebar isDarkMode={isDarkMode} toggleTheme={toggleTheme} onLogout={onLogout}>
        <SidebarItem icon={<LayoutDashboard size={20} />} text="Dashboard"  to="/" />
        <SidebarItem icon={<BarChart3 size={20} />}      text="Statistics"  to="/statistics" />
        <SidebarItem icon={<Upload size={20} />}         text="Upload File" to="/upload" />
      </Sidebar>
